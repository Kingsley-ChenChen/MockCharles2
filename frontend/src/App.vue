...
import TrafficTree from './TrafficTree.vue';
import {useTrafficResize} from './useTrafficResize';
import { activate, bindProject, filterFlows } from './state';
...
const trafficTree=ref<InstanceType<typeof TrafficTree>>();
